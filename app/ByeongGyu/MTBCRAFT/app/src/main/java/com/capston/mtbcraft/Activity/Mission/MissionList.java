...
public class MissionList extends AppCompatActivity {
    ...
    public class GetTask extends AsyncTask<Map<String, String>, Integer, String> {
        ...
        protected String doInBackground(Map<String, String>... maps) {
            ...
            HttpClient.Builder http = new HttpClient.Builder("GET", "http://172.26.1.216:8080/app/getAllMission/" + LoginId);
            // Parameter 를 전송한다.
...
*/
    ...
    public class GetTask2 extends AsyncTask<Map<String, String>, Integer, String> {
        ...
        protected String doInBackground(Map<String, String>... maps) {
            // Http 요청 준비 작업
            //URL은 현재 자기 아이피번호를 입력해야합니다.
            HttpClient.Builder http = new HttpClient.Builder("GET", "http://172.26.1.216:8080/app/getComMission/" + LoginId);
            // Parameter 를 전송한다.
    ...
    public class GetTask3 extends AsyncTask<Map<String, String>, Integer, String> {
        ...
        protected String doInBackground(Map<String, String>... maps) {
            // Http 요청 준비 작업
            //URL은 현재 자기 아이피번호를 입력해야합니다.
            HttpClient.Builder http = new HttpClient.Builder("GET", "http://172.26.1.216:8080/app/getMisRanking");
            // Parameter 를 전송한다.
