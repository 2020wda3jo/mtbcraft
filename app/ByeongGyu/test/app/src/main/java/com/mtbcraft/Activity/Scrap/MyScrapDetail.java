        ...
        navigationView.setNavigationItemSelectedListener(menuItem -> {
            ...
            switch (id) {
                ...
                case R.id.nav_alllist:
                    Intent intent3=new Intent(MyScrapDetail.this, CourseList.class);
                    startActivity(intent3);
                    break;

                case R.id.nav_course:
                    Intent intent4=new Intent(MyScrapDetail.this, MyScrap.class);
                    startActivity(intent4);
                    break;

                case R.id.nav_comp:
                    Intent intent5=new Intent(MyScrapDetail.this, Competition.class);
                    startActivity(intent5);
                    break;
                case R.id.nav_mission:
                    Intent intent6=new Intent(MyScrapDetail.this, Mission.class);
