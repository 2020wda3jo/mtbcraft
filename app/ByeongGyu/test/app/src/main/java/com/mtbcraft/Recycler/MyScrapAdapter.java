...
public class MyScrapAdapter extends RecyclerView.Adapter<MyScrapAdapter.CourseHolder>{
    ...
    public void onBindViewHolder(@NonNull final CourseHolder testViewHolder, final int position) {
        ...
        testViewHolder.textView1.setText(itemList.get(position).getSs_course());
