...
public class Club {
   ...
   public int getCb_manager() {
      return cb_manager;
   }
   public void setCb_manager(int cb_manager) {
   ...
   public int getCb_premium() {
      return cb_premium;
   }
   public void setCb_premium(int cb_premium) {
